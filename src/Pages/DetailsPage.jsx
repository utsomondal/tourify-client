...
const DetailsPage = () => {
  ...
  if (!touristSpot)
    return <p className="text-center mt-10">Tourist spot not found.</p>;

  return (
    <div>
      <button
        onClick={() => navigate(-1)}
        className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600 transition mt-5"
      >
        Back
      </button>
      <div className="p-6 bg-white dark:bg-gray-900 rounded-lg my-5">
